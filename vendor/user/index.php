				...
				<form action="" id="manage-user">	
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="shop_name" class="control-label">Branch Name</label>
						...
						<div class="form-group col-md-6">
							<label for="shop_owner" class="control-label">Branch Manager Fullname</label>
						...
						<div class="form-group col-md-6">
							<label for="shop_type_id" class="control-label">Branch Type</label>
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="logo" class="control-label">Branch Logo</label>
