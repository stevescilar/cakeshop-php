                ...
                <div class="product-img-holder position-relative">
                    ...
                    <div class="card-body border-top border-gray">
                        ...
                        <div class="d-flex w-100">
                            <div class="col-auto px-0"><small class="text-muted">Branch: </small></div>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><small class="text-primary">Ksh. <?= format_num($row['price']) ?></small></p></div>
                        </div>
                            <div class="col-auto px-0"><small class="text-muted">Description: </small></div>
